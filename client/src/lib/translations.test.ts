...
describe('Translations', () => {
  ...
  it('has matching nested keys for all sections', () => {
    ...
    enSections.forEach((section) => {
      const enKeys = Object.keys(translations.en[section as keyof typeof translations.en]).sort();
      const esKeys = Object.keys(translations.es[section as keyof typeof translations.es]).sort();
